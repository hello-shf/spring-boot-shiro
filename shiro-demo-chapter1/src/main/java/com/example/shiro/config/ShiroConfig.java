...
import com.example.shiro.filter.ShiroPermissionsFilter;
...
//		filters.put("roles", new CustomRolesAuthorizationFilter());
		...
		Iterable<SysPermission> sysPermissions = permissionDao.findAll();
		System.out.println(sysPermissions);
		Iterator<SysPermission> iterator = sysPermissions.iterator();
		...
		/*filterChainDefinitionMap.put("/admin/get", "authc, perms[admin:get]");
		filterChainDefinitionMap.put("/vip/get", "authc, perms[vip:get]");
		filterChainDefinitionMap.put("/user/get", "authc, perms[user:get]");*/
